...
const CookieEn = () => {
  ...
  return (
    <>
      <title>Cookies- Qoodo </title>
      <meta name="description" content="Qoodo's Cookies Policy." />
          ...
          <div className="flex flex-col gap-[20px] justify-start items-start w-full">
            ...
            <div id="Introduction" className={containerStyle}>
              ...
              <p className={paraStyle}>
                This privacy policy (“Policy”) describes how Qoodo (“Company,”
                “we,” and “our”) processes, collects, uses and shares personal
                data when using this website https://Qoodo.io/ (the “Website”).
                Please read the following information carefully to understand
                our practices regarding your personal data and how we will
                process data.
              </p>
            </div>
            <div id="Purposes of Processing" className={containerStyle}>
              <h3 className={headStyle}>Purposes of Processing</h3>
              <p className={paraStyle}>
                What is personal data?
                <br />
                <br />
                We collect information about you in a range of forms, including
                personal data. As used in this Policy, “personal data” is as
                defined in the General Data Protection Regulation 20181, this
                includes any information which, either alone or in combination
                with other information we process about you, identifies you as
                an individual, including, for example, your name, postal
                ...
                website. If you registered with us, you will have been asked to
                agree to provide this information in order to access our
                services, purchase our products, or view our content. This
                consent provides us with the legal basis we require under
                applicable law to process your data. You maintain the right to
                withdraw such consent at any time. If you do not agree to our
                use of your personal data in line with this Policy, please do
                not use our website.
                <br />
              </p>
            </div>
            <div id="Collecting Your Personal Data" className={containerStyle}>
              <h3 className={headStyle}>Collecting Your Personal Data</h3>
              <p className={paraStyle}>
                <br />
                <br />
                ⦁ the personal data you provide when you register to use our
                website, including but not limited to your name, postal address,
                email address, telephone number, username, password and
                demographic information (such as your gender);
                <br />
                <br />
                ⦁ the personal data that may be contained in any submission you
                upload or post to the website;
                <br />
                <br />
                ...
                <br />
                <br />
                ⦁ the personal data you provide when you make a purchase through
                our website; and
                <br />
                <br />
                ...
                revoke our access to the information you provide in this way at
                any time by amending the appropriate settings from within your
                account settings on the applicable SNS.
                <br />
                <br />
                ...
                operating system name and version, manufacturer and model,
                browser type, browser language, screen resolution, the website
                you visited before browsing to our website, pages you viewed,
                how long you spent on a page, access times and information about
                your use of and actions on our website. We collect this
                ...
                obligations imposed by law, in which case we will inform you of
                any such processing and provide you with an opportunity to
                object.
              </p>
            </div>
            <div id="Cookies" className={containerStyle}>
              <h3 className={headStyle}>Cookies</h3>
              <p className={paraStyle}>
                What are cookies?
                <br />
                <br />
                ...
                experience on our website. All of our collection of cookies is
                strictly in line with the Electronic Communications Privacy Act
                of 1986 (ECPA)
                <br />
                <br />
                <br />
                <br />
                2.We use two broad categories of cookies: <br />
                <br />
                (1) first party cookies, served directly by us to your computer
                or mobile device, which are used only by us to recognize your
                computer or mobile device when it revisits our website; and{" "}
                <br />
                <br />
                (2) third party cookies, which are served by service providers
                on our website, and can be used by such service providers to
                ...
                <br />
                <br />
                Our website uses the following types of cookies for the purposes
                set out below:
                <br />
                <br />
                <br />
                ...
                <br />
                <br /> These cookies are essential to provide you with services
                ...
                areas of our website and help the content of the pages you
                request load quickly. Without these cookies, the services that
                ...
                more personal experience and to avoid you having to re-enter
                your preferences every time you visit our website.
                <br />
                <br />
                <br />
                <br />
                Analytics and Performance Cookies <br />
                <br />
                These cookies are used to collect information about traffic to
                our website and how users use our website. The information
                gathered does not identify any individual visitor. It includes
                the number of visitors to our website, the websites that
                referred them to our website, the pages they visited on our
                website, what time of day they visited our website, whether they
                have visited our website before, and other similar information.
                ...
                its own cookies. It is only used to improve
                <br />
                <br />
                how our website works. You can find out more information about
                Google Analytics cookies here:
                https://developers.google.com/analytics/resource
                s/concepts/gaConceptsCookies
                <br />
                <br />
                ...
                Google Analytics relating to your use of our website by
                ...
                likely to be of rewards to you. These cookies use information
                about your browsing history to group you with other users who
                have similar rewards. Based on that information, and with our
                permission, third party advertisers can place cookies to enable
                them to show adverts which we think will be relevant to your
                rewards while you are on third party websites.
                <br />
                <br />
                You can disable cookies which remember your browsing habits and
                target advertising at you by visiting
                http://www.youronlinechoices.com/uk/your- ad-choices. If you
                choose to remove targeted or advertising cookies, you will still
                see adverts but they may not be relevant to you. Even if you do
                choose to remove cookies by the companies listed at the above
                link, not all companies that serve online behavioral advertising
                are included in this list, and so you may still receive some
                ...
                on our website or you link your account or engage with our
                ...
                “tools” or “edit” facility). Many browsers are set to accept
                cookies until you change your settings.
                <br />
                <br />
                If you do not accept our cookies, you may experience some
                inconvenience in your use of our website. For example, we may
                not be able to recognize your computer or mobile device and you
                may need to log in every time you visit our website.
                <br />
                <br />
              </p>
            </div>
            <div id="Advertising" className={containerStyle}>
              <h3 className={headStyle}>Advertising</h3>
              <p className={paraStyle}>
                We may use other companies to serve third-party advertisements
                when you visit and use the website. These companies may collect,
                and use clickstream information, browser type, time and date,
                subject of advertisements clicked or scrolled over during your
                visits to the website and other websites in order to provide
                advertisements about goods and services likely to be of reward
                to you. These companies typically use tracking technologies to
                ...
                <br />
                <br />
                <br />⦁ to operate, maintain, and improve our website, products,
                and services;
                <br />
                <br />⦁ to manage your account, including to communicate with
                you regarding your account, if you have an account on our
                website;
                <br />
                <br />⦁ to operate and administer our rewards program and other
                promotions you participate in on our website;
                <br />
                <br />⦁ to respond to your comments and questions and to provide
                customer service;
                <br />
                <br />⦁ to send information including technical notices,
                updates, security alerts, and support and administrative
                messages;
                <br />
                <br />⦁ with your consent, to send you marketing emails about
                upcoming promotions, and other news, including information about
                products and services offered by us and our affiliates. You may
                opt-out of receiving such information at any time: such
                marketing emails tell you how to “opt-out.” Please note, even if
                you opt out of receiving marketing emails, we may still send you
                non-marketing emails. Non-marketing emails include emails about
                your account with us (if you have one) and our business dealings
                with you;
                <br />
                <br />⦁ to process payments you make via our website;
                <br />
                <br />⦁ as we believe necessary or appropriate (a) to comply
                with applicable laws; (b) to comply with lawful requests and
                legal process, including to respond to requests from public and
                ...
                <br />
                <br />⦁ as described in the “Sharing of your Personal Data”
                section below.
              </p>
            </div>
            <div id="Sharing Your Personal Data" className={containerStyle}>
              <h3 className={headStyle}>Sharing Your Personal Data</h3>
              <p className={paraStyle}>
                We may share your personal data as follows:
                <br />
                <br />
                <br />
                <br />⦁ Third Parties Designated by You. We may share your
                personal data with third parties where you have provided your
                consent to do so.
                <br />
                <br />⦁ Our Third-Party Service Providers. We may share your
                personal data with our third- party service providers who
                ...
                features. This Policy does not cover the privacy practices of
                such third parties. These third parties have their own privacy
                policies and we do not accept any responsibility or liability
                for their websites, features or policies. Please read their
                privacy policies before you submit any data to them.
              </p>
            </div>
            <div id="User Generated Content" className={containerStyle}>
              <h3 className={headStyle}>User Generated Content </h3>
              <p className={paraStyle}>
                You may share personal data with us when you submit user
                generated content to our website, including via our rewards
                program, forums, message boards and Websites on our website.
                Please note that any information you post or disclose on our
                website will become public information and will be available to
                other users of our website and to the general public. We urge
                you to be very careful when deciding to disclose your personal
                data, or any other information, on our website. Such personal
                data and other information will not be private or confidential
                once it is published on our website. <br />
                <br /> <br />
                <br />
            ...
            <div id="International Data Transfer" className={containerStyle}>
              <h3 className={headStyle}>International Data Transfer</h3>
              <p className={paraStyle}>
            ...
            <div id="Security" className={containerStyle}>
              <h3 className={headStyle}>Security</h3>
              <p className={paraStyle}>
            ...
            <div id="Szerzői jogok" className={containerStyle}>
              <h3 className={headStyle}>Retention</h3>
              <p className={paraStyle}>
            ...
            <div id="Panaszkezelés" className={containerStyle}>
              <h3 className={headStyle}>Our Policy on Children</h3>
              <p className={paraStyle}>
                Our website is/are not directed to children under 16. If a
                parent or guardian becomes aware that his or her child has
                provided us with information without their consent, he or she
                should contact us. We will delete such information from our
                ...
                personal data outside the EEA. Please note that your use of some
                of the websites may be ineffective upon opt-out.
                <br />
                <br />
                ...
                <br />
                <br />
                (i) what personal data is concerned; and (ii) which of the above
                rights you would like to enforce. For your protection, we may
                ...
                your request as soon as reasonably practicable and in any event,
                within one month of your request. Please note that we may need
              ...
              <div id="Contact Information" className={containerStyle}>
